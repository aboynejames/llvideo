...
//console.log('start new timer object');
  ...
  var socketpi = io.connect('http://192.168.1.44:8850');
                socketpi.on('news', function(data){
  //console.log(data);
                $("#news").append('new content to show, yes');
  });
        ...
        *
        */
        $("#startvlc").click(function(e) {

                e.preventDefault(e);
console.log('start pressed');

                /*
                * VLC video listening socket
                */
                socketpi.emit('vlcvideostart', {'start':'live'});


});


$("#recordvlc").click(function(e) {
...
console.log('record pressed');
                ...
                * VLC video listening socket
                */
                socketpi.emit('vlcvideostart', {'start':'record'});


});

        $("#convertvlc").click(function(e) {
...
console.log('convert pressed');
                ...
                * VLC video listening socket
                */
                socketpi.emit('vlcvideostart', {'start':'convert'});
...
//INITIALIZE
        ...
        $('.btnFwd').on('click', function() { fastfowrd(this, 0.05); });
